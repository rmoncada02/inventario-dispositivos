            ...
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="ubicacion" wire:model="ubicacion">
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="encargado" class="block text-gray-700 text-sm font-bold mb-2">Encargado:</label>
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="encargado" wire:model="encargado">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="modelo" wire:model="modelo">
                    </div>

                    <div class="mb-4">
                        <label for="numero_serie" class="block text-gray-700 text-sm font-bold mb-2">Número de Serie:</label>
                        <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="numero_serie" wire:model="numero_serie">
                    </div>
