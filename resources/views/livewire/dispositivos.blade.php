    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <div class="flex justify-between mb-4">
                ...
                <div class="flex">
                    <input type="text" wire:model.debounce.300ms="search" placeholder="Búsqueda" class="form-input rounded-md shadow-sm mt-1 block w-full">
                    <button wire:click="actualizarBusqueda" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded ml-2">Buscar</button>
                </div>
            </div>
